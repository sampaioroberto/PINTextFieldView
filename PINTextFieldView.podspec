...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PINTextFieldView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ssampaio.roberto@gmail.com/PINTextFieldView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Roberto Sampaio' => 'ssampaio.roberto@gmail.com'' }
  s.source           = { :git => 'https://github.com/ssampaio.roberto@gmail.com/PINTextFieldView.git', :tag => s.version.to_s }
